...
cafile_path = '/Users/kent/github/connectors/http_ca.crt'

# Elasticsearch  credentials for caching incremental cursor
es_host = 'dev1'  
es_port = 9200  
es_api_key = 'VmNlVlJZMEJLWWZKS1MzcERERVE6ck1kd0JjZ3JRaE9aLUtaT0ZiVktrQQ=='
...
class SncmdbDataSource(BaseDataSource):
    ...
    def get_default_configuration(cls):
        ...
        return {
            "domain": {
                "order": 1,
                "value": "dev196416.service-now.com",
    ...
    def _check_cache(self, sn_table):
        es = Elasticsearch([f'https://{es_host}:{es_port}'],
